	...
	<div class="row register">
        <div class="col-md-6 col-md-offset-3">
                <h2>Fill in your details</h2>
                    <form method="POST" action="{{ route('public.checkoutPaypal') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('street_number') ? ' has-error' : '' }}">
                            ...
                            <input id="street_number" type="text" name="street_number" value="@guest{{ old('street_number') }}@else{{ Auth::user()->street_number }}@endguest" required >
